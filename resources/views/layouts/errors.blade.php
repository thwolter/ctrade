...
<head>
    ...
    <style>
        ...
        .background-image {
            ...
            /*background-image: url(//capmyrisk.com/img/home/portfolio.jpg) !important;*/
        }
        ...
        .border-button {
            color: rgba(74, 128, 198, 1) !important;
            border-color: rgba(74, 128, 198, 1) !important;
        }
        .button {
            background-color: rgba(74, 128, 198, 1) !important;
...
<center>
    <div class="content-container shadow">
        ...
        <div class="buttons-container">
            <a class="button" href="http://capmyrisk.com" target="_blank">
                <span class="fa fa-home"></span> {{ trans('errorpages.goto') }}
            </a>
            <a class="button" href="mailto:report@capmyrisk.com" target="_blank">
                <span class="fa fa-warning"></span> {{ trans('errorpages.report') }}
            </a>
        </div>
    </div>
</center>
