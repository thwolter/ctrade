...
<div id="transaction" class="card border-0 rounded-0 g-mb-40" role="tablist" aria-multiselectable="true">
    ...
    <div id="{{ $id }}-heading" role="tab"
         class="align-items-center border-0 d-flex g-mb-15 justify-content-end">
        <h3 class="h6 g-pa-5">

            @if ($doCollapse)
                <a class="btn collapsed g-color-gray-dark-v3 g-text-underline--none--hover u-btn-outline-lightgray" href="#{{ $id }}-body"
