<nav class="navbar navbar-toggleable-sm navbar-light bg-faded yamm">
    <div class="container">
        ...
        <a class="navbar-brand" href="index.html"><img src="assets/img/logo-dark.png" class="img-fluid" alt=""></a>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li><a href="home-master.html" class="dropdown-item">Home - Master Slider <span class="badge badge-primary">Hot</span></a></li>
                        ...
                        <li><a href="home-onepage.html" class="dropdown-item">One Page</a></li><li><a href="home-onepage-option.html" class="dropdown-item">One Page Option</a></li>
                ...
                <!--mega menu-->
                <li class="dropdown dropdown-fw nav-item active">
                ...
                <li class="social-nav nav-item"><a href="#" class="nav-link"><i class="ion-social-twitter"></i></a></li>
                <li class="social-nav nav-item"><a href="#" class="nav-link"><i class="ion-social-youtube"></i></a></li>
            </ul>
        </div>
    </div>
</nav><!--nav end-->